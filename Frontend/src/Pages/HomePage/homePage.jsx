  ...
  return (
    <div className="home_page">
      ...
      <div className="corusel">
        <img
          src="./Utilis/Homepage1(Corosal).webp"
          alt="Image 1"
          className="corusel_img1"
        />
        <img
          src="./Utilis/Homepage2(Corosal).webp"
          alt="Image 2"
          className="corusel_img2"
        />
        <img
          src="./Utilis/Homepage3(Corosal).webp"
          alt="Image 3"
          className="corusel_img3"
        />
        <img
          src="./Utilis/Homepage4(Corosal).webp"
          alt="Image 4"
          className="corusel_img4"
        />
      </div>
