      ...
      <div className="product-info">
        ...
        <div className="price-row">
         ...
         <div className="parents">
          ...
          <p className="pragraph">Embrace sophistication with Red Tape Derby formal shoes for men in black, designed for both style and comfort. These formal shoes feature a premium leather upper that delivers a smooth, polished finish, ideal for office wear and formal occasions. The soft fabric lining offers a gentle touch, while the high-density foam insole ensures excellent cushioning and support for extended wear. The TPR sole enhances durability, flexibility, and reliable traction for confident steps. Featuring a classic low-cut Derby design, these shoes are finished with a round toe and flat heel for all-day comfort and style.</p>
